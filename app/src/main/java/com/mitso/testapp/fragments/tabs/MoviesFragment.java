...
public class MoviesFragment extends BaseFragment implements IEntryHandler {
    ...
    private List<Entry>                     mApiMovieList;
    private List<Entry>                     mDbMovieList;
    ...
    public void getMoviesFromApi() {
        ...
        final ApiGetEntryListTask apiGetEntryListTask = new ApiGetEntryListTask(Constants.CONTENT_TYPE_MOVIE);
        apiGetEntryListTask.setCallback(new ApiGetEntryListTask.Callback() {
            ...
            public void onSuccess(List<Entry> _result) {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    Log.i(apiGetEntryListTask.LOG_TAG, "ON SUCCESS: MOVIE LIST IS TAKEN FROM API.");

                    mApiMovieList = new ArrayList<>(_result);
            ...
            public void onFailure(Throwable _error) {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    Log.e(apiGetEntryListTask.LOG_TAG, "ON FAILURE: MOVIE LIST IS NOT TAKEN FROM API.");
    ...
    private void saveMoviesToDatabase() {
        ...
        final DbSaveEntryListTask dbSaveEntryListTask = new DbSaveEntryListTask(mMainActivity, mApiMovieList, DatabaseHelper.DATABASE_MOVIES_TABLE);
        dbSaveEntryListTask.setCallback(new DbSaveEntryListTask.Callback() {
            ...
            public void onSuccess() {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    Log.i(dbSaveEntryListTask.LOG_TAG, "ON SUCCESS: MOVIE LIST IS SAVED TO DATABASE.");

                    mFinalList = mSupport.compareLists(mDbFavouriteList, mApiMovieList);
            ...
            public void onFailure(Throwable _error) {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    Log.e(dbSaveEntryListTask.LOG_TAG, "ON FAILURE: MOVIE LIST IS NOT SAVED TO DATABASE.");
    ...
    private void getMoviesFromDatabase() {
        ...
        final DbGetEntryListTask dbGetEntryListTask = new DbGetEntryListTask(mMainActivity, DatabaseHelper.DATABASE_MOVIES_TABLE);
        dbGetEntryListTask.setCallback(new DbGetEntryListTask.Callback() {
            @Override
            public void onSuccess(List<Entry> _result) {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    if (!_result.isEmpty()) {
                        ...
                        Log.i(dbGetEntryListTask.LOG_TAG, "ON SUCCESS: MOVIE LIST IS TAKEN FROM DATABASE.");

                        mDbMovieList = new ArrayList<>(_result);
                        mFinalList = mSupport.compareLists(mDbFavouriteList, mDbMovieList);
                        ...
                        Log.i(dbGetEntryListTask.LOG_TAG, "ON SUCCESS: MOVIE LIST IS EMPTY.");
            ...
            public void onFailure(Throwable _error) {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    Log.e(dbGetEntryListTask.LOG_TAG, "ON FAILURE: MOVIE LIST IS NOT FROM DATABASE.");
                    Log.e(dbGetEntryListTask.LOG_TAG, _error.toString());
    ...
    public void addOrDelete(Entry _entry, int _position) {
        ...
        if (!_entry.isAddedToFavourites())
            addMovieToFavourites(_entry, _position);
        else
            deleteMovieFromFavourites(_entry, _position);
    }

    private void addMovieToFavourites(final Entry _entry, final int _position) {
        ...
        dbAddEntryTask.setCallback(new DbAddEntryTask.Callback() {
            ...
            public void onSuccess() {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    Log.i(dbAddEntryTask.LOG_TAG, "ON SUCCESS: MOVIE IS ADDED TO FAVOURITES DATABASE.");
            ...
            public void onFailure(Throwable _error) {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    Log.e(dbAddEntryTask.LOG_TAG, "ON FAILURE: MOVIE IS NOT ADDED TO FAVOURITES DATABASE.");
    ...
    private void deleteMovieFromFavourites(final Entry _entry, final int _position) {
        ...
        dbDeleteEntryTask.setCallback(new DbDeleteEntryTask.Callback() {
            ...
            public void onSuccess() {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    Log.i(dbDeleteEntryTask.LOG_TAG, "ON SUCCESS: MOVIE IS DELETED FROM FAVOURITES DATABASE.");
            ...
            public void onFailure(Throwable _error) {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    Log.e(dbDeleteEntryTask.LOG_TAG, "ON FAILURE: MOVIE IS NOT DELETED TO FAVOURITES DATABASE.");
