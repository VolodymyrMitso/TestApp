...
public class MoviesFragment extends BaseFragment implements IEntryHandler {
        ...
        dbSaveEntryListTask.setCallback(new DbSaveEntryListTask.Callback() {
            ...
            public void onSuccess() {
                ...
                if (mMainActivity != null && isAdded()) {
                    ...
                    initRecyclerView(mApiMovieList);
                    setHandler();
    ...
    public void addToFavourites(Entry _entry) {
        ...
        if (!mDbFavouriteList.contains(_entry)) {
            ...
            addMovieToFavouritesDatabase(_entry);

        } else {

            Log.i(LOG_TAG, "MOVIE IS ALREADY IN FAVOURITES DATABASE.");
            mSupport.showToastAlreadyIn(mMainActivity);
        }
    }

    private void addMovieToFavouritesDatabase(Entry _entry) {
